...
int main(){
  ...
  string newData[4] = {"Ekayana Maggo Yonanda", "ekayanaa", "ekayana@gmail.com", "gampangAja"};
  createDoubleLinkedList(newData);

  printDoubleLinkedList();

  string data2[4] = {"M. Ilham Nugroho", "ilhm", "bambangMas@gmail.com", "MasM. Ilham Nugroho"};

  addFirst( data2 );

  printDoubleLinkedList();

  string data3[4] = {"Ahmad Rafif", "apipp", "apippp@gmail.com", "apippae"};

  addLast( data3 );

  printDoubleLinkedList();

  string data4[4] = {"Kenny C", "ken", "kenCor@yahoo.com", "Kennnny"};
  addMiddle(data4, 3);
